...
[![Build Status](https://github.com/itential/job-metrics-exporter/actions/workflows/ci.yml/badge.svg)](https://github.com/itential/job-metrics-exporter/actions/workflows/ci.yml)
[![License](https://img.shields.io/badge/License-GPL--3.0-blue.svg)](LICENSE)
[![GitHub release](https://img.shields.io/github/v/release/itential/job-metrics-exporter)](https://github.com/itential/job-metrics-exporter/releases)
-->
...
A brief description of what job-metrics-exporter does and why it exists.
...
# Examples:
# pip install job-metrics-exporter
# npm install -g job-metrics-exporter
# brew install itential/tap/job-metrics-exporter
# go install github.com/itential/job-metrics-exporter@latest
```
...
# go build -o job-metrics-exporter .
# cargo build --release
```
...
```bash
# Configure a device
job-metrics-exporter configure --target router1.example.com --config network.yaml
